var docname = window.location.pathname.split('/').reverse(),
	...
	noticeText = '<p>This application is Copyright © 2015, daumkakao corp. All Rights Reserved. </p><p>This application use Open Source Software (OSS). You can find the source code of these open source projects, along with applicable license information, below. We are deeply grateful to these developers for their work and contributions.</p><p>Any questions about our use of licensed work can be sent to <a href="mailto:oss@daumkakao.com">oss@daumkakao.com</a><p>';
$(function() {
