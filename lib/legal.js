var docname = window.location.pathname.split('/').reverse(),
	...
	noticeText = '<p>This application is Copyright © 2019 회사명. All Rights Reserved. </p><p>This application use Open Source Software (OSS). You can find the source code of these open source projects, along with applicable license information, below. We are deeply grateful to these developers for their work and contributions.</p>';
$(function() {
